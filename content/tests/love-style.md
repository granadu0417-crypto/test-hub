...
title: "연애 스타일 테스트"
date: 2025-01-21
description: "나의 연애 유형과 이상형을 찾는 무료 심리테스트! 12가지 질문으로 8가지 연애 스타일(불타는 로맨티스트, 차분한 안정파 등)을 분석하고 최고의 궁합 파트너를 찾아보세요. 2-3분이면 완성!"
...
questions:
  - question: "좋아하는 사람이 생겼을 때 나는?"
    options:
      - text: "적극적으로 먼저 다가가서 빠르게 친해진다"
        scores:
          energy: 3
          emotional: 1
      - text: "천천히 관찰하면서 신중하게 접근한다"
        scores:
          energy: -3
          emotional: -1
  ...
  - question: "연애 초기에 선호하는 데이트는?"
    options:
      - text: "특별한 장소에서 이벤트가 있는 데이트"
        scores:
          emotional: 2
          energy: 2
      - text: "편한 카페에서 오래 대화하는 데이트"
        scores:
          emotional: -2
          energy: -2
  ...
  - question: "연인과 싸웠을 때 나의 반응은?"
    options:
      - text: "바로 감정을 표현하고 즉시 해결하려 한다"
        scores:
          energy: 3
          emotional: 1
      - text: "시간을 두고 차분히 생각한 후 대화한다"
        scores:
          energy: -3
          emotional: -1
  ...
  - question: "사랑을 표현하는 나만의 방식은?"
    options:
      - text: "말과 행동으로 자주, 직접적으로 표현"
        scores:
          energy: 2
          emotional: 2
      - text: "조용히 실질적인 도움과 배려로 표현"
        scores:
          energy: -2
          emotional: -2
  ...
  - question: "이상적인 연애 진행 속도는?"
    options:
      - text: "빠르게 친밀해지고 열정적으로"
        scores:
          energy: 3
          emotional: 1
      - text: "천천히 깊어지면서 안정적으로"
        scores:
          energy: -3
          emotional: -1
  ...
  - question: "연인에게 받고 싶은 선물은?"
    options:
      - text: "로맨틱한 편지, 꽃, 감성적인 선물"
        scores:
          emotional: 3
          energy: 0
      - text: "실용적이고 필요한 것, 유용한 선물"
        scores:
          emotional: -3
          energy: 0
  ...
  - question: "기념일에 대한 생각은?"
    options:
      - text: "특별하게 준비하고 이벤트를 만든다"
        scores:
          emotional: 2
          energy: 2
      - text: "평소처럼 자연스럽게 의미있게 보낸다"
        scores:
          emotional: -2
          energy: -2
  ...
  - question: "갈등이 생겼을 때 나는?"
    options:
      - text: "감정을 솔직하게 표현하며 적극적으로 풀어간다"
        scores:
          energy: 3
          emotional: 2
      - text: "침착하게 분석하고 논리적으로 해결한다"
        scores:
          energy: -3
          emotional: -2
    ...
    options:
      - text: "사랑이 있다면 거리는 문제없다"
        scores:
          emotional: 3
          energy: 1
      - text: "현실적으로 어렵고 만남이 중요하다"
        scores:
          emotional: -3
          energy: -1

  - question: "연애할 때 나의 우선순위는?"
    options:
      - text: "감정과 로맨스, 설레는 순간"
        scores:
          emotional: 3
          energy: 1
      - text: "신뢰와 책임감, 안정적인 관계"
        scores:
          emotional: -3
          energy: -1
