...
title: "사회성 테스트"
date: 2025-01-21
description: "2025년 사회성 테스트! 나의 사교 능력은? 대인관계 유형과 소통 스타일을 심리학적으로 분석하는 무료 성격 테스트 - 2-3분 완성"
summary: "사회성 유형을 알아보고 더 편안한 인간관계를 만들어보세요"
icon: "👥"
category: "personality"
badge: "NEW"
featured: false
ogImage: "og/og-sociability.png"
...
questions:
  - question: "처음 만난 사람들과 있을 때?"
    options:
      - text: "먼저 말을 걸고 분위기를 주도한다"
        scores:
          energy: 3
          breadth: 2
      - text: "적극적으로 참여하고 대화한다"
        scores:
          energy: 2
          breadth: 1
      - text: "조용히 듣다가 필요할 때만 말한다"
        scores:
          energy: -2
          breadth: -1
      - text: "매우 불편하고 빨리 끝나길 바란다"
        scores:
          energy: -3
          breadth: -2
  ...
  - question: "대화할 때 나는?"
    options:
      - text: "누구와도 쉽게 대화를 시작한다"
        scores:
          energy: 3
          breadth: 3
      - text: "친한 사람과는 적극적으로 대화한다"
        scores:
          energy: 1
          breadth: -2
  ...
  - question: "새로운 환경에 적응하는 속도는?"
    options:
      - text: "즉시 적응하고 여러 사람과 친해진다"
        scores:
          energy: 3
          breadth: 3
      - text: "빠르게 적응하고 몇 명과 친해진다"
        scores:
          energy: 2
          breadth: -1
      - text: "시간이 걸리지만 점차 친해진다"
        scores:
          energy: -1
          breadth: 0
      - text: "적응이 매우 어렵다"
  ...
  - question: "에너지 충전 방법은?"
    options:
      - text: "많은 사람들과 어울리면 활력이 생긴다"
        scores:
          energy: 3
          breadth: 2
      - text: "친한 사람들과 있으면 힐링된다"
        scores:
          energy: 1
          breadth: -2
      - text: "혼자만의 조용한 시간이 필요하다"
        scores:
          energy: -3
          breadth: -1
      - text: "완전히 혼자 있어야 충전된다"
        scores:
          energy: -3
          breadth: -3
  ...
  - question: "친구 관계는?"
    options:
      - text: "많은 친구들과 두루두루 잘 지낸다"
        scores:
          energy: 2
          breadth: 3
      - text: "적당한 수의 친구들과 균형있게 지낸다"
        scores:
          energy: 0
          breadth: 0
      - text: "소수의 친구와 깊게 지낸다"
    ...
    options:
      - text: "많은 사람들과 즐거운 시간"
        scores:
          energy: 3
          breadth: 3
      - text: "다양한 사람들과의 균형있는 관계"
        scores:
          energy: 1
          breadth: 1
      - text: "소수와의 깊고 의미있는 관계"
        scores:
          energy: -1
          breadth: -3
      - text: "자기 자신과의 시간"
