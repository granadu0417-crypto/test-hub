...
title: "소비 성향 테스트"
date: 2025-01-21
description: "나의 소비 습관은? 12가지 질문으로 8가지 소비 성향(철저한 저축가, 계획적 소비자 등)을 분석하고 현명한 재테크 방법을 알아보세요. 무료 소비 성향 테스트 2-3분 완성!"
...
questions:
  - question: "월급을 받으면 가장 먼저 하는 일은?"
    options:
      - text: "저축과 투자 계좌로 일정 금액을 자동이체한다"
        scores:
          saving: 3
          planning: 2
      - text: "계획한 저축 금액을 이체한다"
        scores:
          saving: 2
          planning: 3
      - text: "필요한 것을 먼저 사고 남으면 저축한다"
        scores:
          saving: -2
          planning: 0
      - text: "특별한 계획 없이 쓴다"
  ...
  - question: "쇼핑을 할 때 나는?"
    options:
      - text: "리스트를 만들어서 계획한 것만 구매한다"
        scores:
          saving: 2
          planning: 3
      - text: "예산 내에서 필요한 것을 산다"
        scores:
          saving: 1
          planning: 2
      - text: "마음에 드는 것을 산다"
  ...
  - question: "친구들과 외식할 때 나는?"
    options:
      - text: "비용을 고려해서 합리적인 곳을 제안한다"
        scores:
          saving: 3
          planning: 2
      - text: "예산 내에서 좋은 곳을 찾는다"
        scores:
          saving: 1
          planning: 2
  ...
  - question: "저축이나 투자에 대한 생각은?"
    options:
      - text: "목표를 세우고 꾸준히 실천 중이다"
        scores:
          saving: 3
          planning: 3
      - text: "중요하다고 생각하고 하고 있다"
        scores:
          saving: 2
          planning: 1
    ...
    options:
      ...
      - text: "평소 사고 싶었던 것을 산다"
        scores:
          saving: -2
          planning: -1
      - text: "즉흥적으로 여행이나 쇼핑을 간다"
        scores:
          saving: -3
          planning: -3

  - question: "재테크 공부나 정보 수집은?"
    options:
      - text: "꾸준히 공부하고 실천한다"
        scores:
          saving: 2
