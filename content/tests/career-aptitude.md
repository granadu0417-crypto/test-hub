...
title: "직업 적성 테스트"
date: 2025-01-21
description: "나에게 맞는 직업 찾기! 12가지 질문으로 8가지 직업 적성 유형(공감형 리더, 창의적 협력자 등)을 분석하고 나의 강점과 재능에 딱 맞는 진로를 찾아보세요. 무료 직업 적성 검사 2분 완성!"
...
questions:
  ...
  - question: "선호하는 업무 환경은?"
    options:
      - text: "사람들과 활발하게 소통하는 환경"
        scores:
          people: 3
          structure: -1
      - text: "팀워크는 있지만 독립적으로 일하는 환경"
        scores:
          people: 1
          structure: 2
      - text: "혼자 집중할 수 있는 조용한 환경"
        scores:
          people: -3
          structure: 1
      - text: "자유롭고 창의적인 환경"
  ...
  - question: "새로운 프로젝트를 시작할 때 나는?"
    options:
      - text: "팀원들과 브레인스토밍하며 아이디어를 모은다"
        scores:
          people: 3
          structure: -1
      - text: "체계적인 계획과 일정을 먼저 세운다"
        scores:
          people: 0
          structure: 3
      - text: "창의적이고 자유로운 아이디어를 낸다"
        scores:
          people: -1
          structure: -3
      - text: "데이터와 사례를 분석한다"
  ...
  - question: "업무 중 어려운 문제가 생겼을 때?"
    options:
      - text: "동료들과 협력해서 함께 해결한다"
        scores:
          people: 3
          structure: 0
      - text: "논리적으로 분석하고 체계적으로 해결한다"
        scores:
          people: -2
          structure: 3
      - text: "창의적인 대안을 찾아본다"
  ...
  - question: "장기 커리어 목표는?"
    options:
      - text: "많은 사람들에게 도움을 주는 전문가"
        scores:
          people: 3
          structure: 1
      - text: "조직을 이끄는 리더나 경영자"
        scores:
          people: 1
          structure: 3
      - text: "창의적인 작품을 만드는 크리에이터"
        scores:
          people: -1
          structure: -3
      - text: "해당 분야의 최고 전문가"
